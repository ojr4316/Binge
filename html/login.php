...
<body class="popcornBg">
  <header class="header" id="header">
    ...
    <div id="loginForm" class="mt-5 mx-auto">
<form class="text-center fill-white shadow-sm p-3 mb-5 bg-white rounded p-5 binge-white-box" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    <h3>Sign in</h3>
    ...
    <p>Not a member?
        <a href="register.php" class="binge-red">Register</a>
    </p>
</form>
</div>
