...
<body>
  ...
  <header class="header" id="header">
    ...
    <div id="registerForm" class="mx-auto m-5">
<form class="text-center fill-white shadow-sm p-3 mb-5 bg-white p-5 binge-white-box" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    <h3>Register</h3>
    ...
    <p>Already have an account?
        <a href="login.php" class="binge-red">Sign in</a>
    </p>
</form>
</div>
