  ...
  <div class="col mx-auto text-center">
      <div class="row pt-5 pb-5 no-pad-small">
          <div class="col-lg lil-pad-small">
              ...
              <p class="binge-red col-text"> Find anything you'd like to watch and create a watch request </p>
          </div>
          ...
          <div class="col-lg ml-3 lil-pad-small">
              ...
              <p class="binge-red col-text"> View watch requests from other users and join them </p>
          </div>

          <div class="col-lg ml-3 lil-pad-small">
              <i style="animation-delay: 0.6s" class="fas fa-comments binge-red spin-anim icon-pad"></i>
              <h3 class="binge-red"> Chats </h3>
              <p class="binge-red col-text"> Make plans with other users for your next binge session </p>
          </div>
      </div>
    </div>
    <hr class="mr-5">
